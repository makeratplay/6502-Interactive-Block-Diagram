...
var controlLines = [
    { Name: "DL/DB",  left:	605, top: 155, Register: "Input Data Latch (DL)", BusEnable: "DB", direction: "fa-arrow-circle-down", Note: "" },
    { Name: "DL/ADL", left:	833, top: 155, Register: "Input Data Latch (DL)", BusEnable: "ADL", direction: "fa-arrow-circle-down", Note: ""  },
    { Name: "DL/ADH", left:	1064, top: 155, Register: "Input Data Latch (DL)", BusEnable: "ADH", direction: "fa-arrow-circle-down", Note: "" },
    { Name: "PHI2",   left:	578, top: 127, Register: "Input Data Latch (DL)", LoadEnable: true, direction: "fa-arrow-circle-right", Note: ""  },
   
    { Name: "PHI2",   left:	410, top: 127, Register: "Predecode Register (PD)", LoadEnable: true, direction: "fa-arrow-circle-left", Note: ""  },

    { Name: "PHI1",   left:	565, top: 305, Register: "Data Output Register (DOR)", LoadEnable: true, direction: "fa-arrow-circle-left", Note: ""  },


    { Name: "PHI2",   left:	578, top: 398, Register: "DB Precharge Mosfets", BusEnable: "DB", direction: "fa-arrow-circle-right", Note: "" },


    { Name: "PCL/PCL", left: 665, top: 225, Register: "Program Counter Low Select Register (PCLS)", LoadEnable: true, direction: "fa-arrow-circle-right", Note: "" },
    { Name: "ADLPCL",  left: 787, top: 225, Register: "Program Counter Low Select Register (PCLS)", LoadEnable: true, direction: "fa-arrow-circle-left", Note: "" },

    { Name: "~IPC",  left: 680, top: 290, Register: "Program Counter Low Increment Logic", LoadEnable: true, direction: "fa-info-circle", Note: "Carry in" },


    { Name: "PHI2",  left: 725, top: 365, Register: "Program Counter Low Register (PCL)", LoadEnable: true, direction: "fa-arrow-circle-down", Note: "" },
    { Name: "PCL/DB",  left: 665, top: 425, Register: "Program Counter Low Select Register (PCLS)", LoadEnable: true, direction: "fa-arrow-circle-left", Note: "" },
    { Name: "PCLADL",  left: 788, top: 410, Register: "Program Counter Low Select Register (PCLS)", LoadEnable: true, direction: "fa-arrow-circle-right", Note: "" },

    { Name: "0ADL0",   left:	802, top: 545, Register: "ADL Open Drain Mosfets", BusEnable: "ADL", direction: "fa-arrow-circle-right", Note: "" },
    { Name: "0ADL1",   left:	802, top: 545, Register: "ADL Open Drain Mosfets", BusEnable: "ADL", direction: "fa-arrow-circle-right", Note: "" },
    { Name: "0ADL2",   left:	802, top: 545, Register: "ADL Open Drain Mosfets", BusEnable: "ADL", direction: "fa-arrow-circle-right", Note: "" },

    { Name: "PHI2",   left:	802, top: 661, Register: "ADL Precharge Mosfets", BusEnable: "ADL", direction: "fa-arrow-circle-right", Note: "" },

    { Name: "PCH/PCH",  left: 895, top: 220, Register: "Program Counter High Select Register (PCHS)", LoadEnable: true, direction: "fa-arrow-circle-right", Note: "" },
    { Name: "ADHPCH",  left: 1017, top: 220, Register: "Program Counter High Select Register (PCHS)", LoadEnable: true, direction: "fa-arrow-circle-left", Note: "" },
    
    { Name: "PHI2",  left: 954, top: 430, Register: "Program Counter High Register (PCH)", LoadEnable: true, direction: "fa-arrow-circle-down", Note: "" },
    { Name: "PCH/DB",  left: 895, top: 487, Register: "Program Counter High Register (PCH)", BusEnable: "DB", direction: "fa-arrow-circle-left", Note: "" },
    { Name: "PCHADH",  left: 1017, top: 474, Register: "Program Counter High Register (PCH)", BusEnable: "ADH", direction: "fa-arrow-circle-right", Note: "" },


    { Name: "SBDB",  left: 957, top: 602, Register: "SB/DB Pass Mosfets", BusEnable: "DB", direction: "fa-arrow-circle-right", Note: "" },
    { Name: "SBDB",  left: 862, top: 602, Register: "DB/SB Pass Mosfets", BusEnable: "SB", direction: "fa-arrow-circle-left", Note: "" },

    { Name: "SB/ADH",  left: 1065, top: 530, Register: "SB/ADH Pass Mosfets", BusEnable: "ADH", direction: "fa-arrow-circle-up", Note: "" },
    { Name: "SB/ADH",  left: 1065, top: 581, Register: "ADH/SB Pass Mosfets", BusEnable: "SB", direction: "fa-arrow-circle-down", Note: "" },

    { Name: "ADH/ABH",  left: 1110, top: 425, Register: "Address Bus High Register (ABH)", LoadEnable: true, direction: "fa-arrow-circle-right", Note: "" },
    
    { Name: "0/ADH(1-7)",  left: 1091, top: 263, Register: "ADH Open Drain Mosfets", BusEnable: "ADH", direction: "fa-arrow-circle-left", Note: "" },
    { Name: "0/ADH0",  left: 1091, top: 263, Register: "ADH Open Drain Mosfets", BusEnable: "ADH", direction: "fa-arrow-circle-left", Note: "" },        
    
    { Name: "PHI2",   left:	1091, top: 190, Register: "ADH Precharge Mosfets", BusEnable: "DB", direction: "fa-arrow-circle-left", Note: "" },


    { Name: "SB/S",  left: 1020, top: 686, Register: "Stack Pointer Register (S)", LoadEnable: true, direction: "fa-arrow-circle-left", Note: "" },
    { Name: "S/ADL",  left: 880, top: 703, Register: "Stack Pointer Register (S)", BusEnable: "ADL", direction: "fa-arrow-circle-left", Note: "" },
    { Name: "S/SB",  left: 1020, top: 718, Register: "Stack Pointer Register (S)", BusEnable: "SB", direction: "fa-arrow-circle-right", Note: "" },
    { Name: "SS",  left: 900, top: 675, Register: "Stack Pointer Register (S)", LoadEnable: true, direction: "fa-info-circle", Note: "Hold" },

    { Name: "ADL/ABL",  left: 1110, top: 840, Register: "Address Bus Low Register (ABL)", LoadEnable: true, direction: "fa-arrow-circle-right", Note: "" },

    { Name: "SB/X",  left: 1120, top: 1050, Register: "X Index Register (X)", LoadEnable: true, direction: "fa-arrow-circle-right", Note: "" },
    { Name: "X/SB",  left: 1120, top: 1106, Register: "X Index Register (X)", BusEnable: "SB", direction: "fa-arrow-circle-left", Note: "" },

    { Name: "SB/Y",  left: 1120, top: 1287, Register: "Y Index Register (Y)", LoadEnable: true, direction: "fa-arrow-circle-right", Note: "" },
    { Name: "Y/SB",  left: 1120, top: 1345, Register: "Y Index Register (Y)", BusEnable: "SB", direction: "fa-arrow-circle-left", Note: "" },
    ...
    { Name: "0ADD",  left: 677, top: 1165, Register: "A Input Regiter (AI)", LoadEnable: true, direction: "fa-arrow-circle-up", Note: "" },


    { Name: "PHI2",  left: 990, top: 795, Register: "Precharge Mosfets", BusEnable: "SB", direction: "fa-arrow-circle-right", Note: "" },

    { Name: "ADDSB06",  left: 1000, top: 955, Register: "Adder Hold Register (ADD)", BusEnable: "SB", direction: "fa-arrow-circle-right", Note: "" },
    { Name: "ADDSB7",  left: 1000, top: 955, Register: "Adder Hold Register (ADD)", BusEnable: "SB", direction: "fa-arrow-circle-right", Note: "" },
    { Name: "ADDADL",  left: 944, top: 880, Register: "Adder Hold Register (ADD)", BusEnable: "ADL", direction: "fa-arrow-circle-up", Note: "" },
    { Name: "PHI2",  left: 885, top: 956, Register: "Adder Hold Register (ADD)", LoadEnable: true, direction: "fa-arrow-circle-right", Note: "" },

    { Name: "NDB/ADD",  left: 658, top: 775, Register: "B Input Register (BI)", LoadEnable: true, direction: "fa-arrow-circle-down", Note: "" },
    { Name: "DBADD",  left: 716, top: 775, Register: "B Input Register (BI)", LoadEnable: true, direction: "fa-arrow-circle-down", Note: "" },
    { Name: "ADL/ADD",  left: 774, top: 775, Register: "B Input Register (BI)", LoadEnable: true, direction: "fa-arrow-circle-down", Note: "" },



    { Name: "SUMS",  left: 805, top: 885, Register: "Arithmetic Logic With Decimal Carry Look-A-Head (CD)", BusEnable: "ADD", direction: "fa-arrow-circle-right", Note: "" },
    { Name: "ANDS",  left: 805, top: 920, Register: "Arithmetic Logic With Decimal Carry Look-A-Head (CD)", BusEnable: "ADD", direction: "fa-arrow-circle-right", Note: "" },
    { Name: "EORS",  left: 805, top: 956, Register: "Arithmetic Logic With Decimal Carry Look-A-Head (CD)", BusEnable: "ADD", direction: "fa-arrow-circle-right", Note: "" },
    { Name: "ORS",  left: 805, top: 992, Register: "Arithmetic Logic With Decimal Carry Look-A-Head (CD)", BusEnable: "ADD", direction: "fa-arrow-circle-right", Note: "" },
